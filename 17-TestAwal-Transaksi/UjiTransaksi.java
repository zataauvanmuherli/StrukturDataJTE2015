...
public class UjiTransaksi {
    ...
    public void saldo() {
        ...
        assertNotNull(transaksi);
        assertNotNull(transaksi.kredit());
        assertTrue(transaksi.saldo(new BigInteger(saldoAwalStr)) instanceof BigInteger);
        assertEquals(transaksi.saldo(new BigInteger(saldoAwalStr)).toString(), hasilStr);
        assertEquals(transaksi.saldoStr(new BigInteger(saldoAwalStr)), hasilStr);
    }
    
    private String debitStr = "123";
    private String kreditStr = "456";
    private String saldoAwalStr = "789";
    private String hasilStr = "456";
